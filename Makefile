...
DOCKER_IMAGE_NAME_PREFIX = flipcash-protobuf-api-builder
...
generate-go:
	...
	@mv $(PROTO_OUT_GO_DIR)/github.com/code-payments/flipcash-protobuf-api/generated/go/* $(PROTO_OUT_GO_DIR)
