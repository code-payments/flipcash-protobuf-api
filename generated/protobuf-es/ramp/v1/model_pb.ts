...
// @generated from file ramp/v1/model.proto (package flipcash.ramp.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum flipcash.ramp.v1.Provider
 */
...
proto3.util.setEnumType(Provider, "flipcash.ramp.v1.Provider", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "COINBASE" },
]);

/**
 * @generated from message flipcash.ramp.v1.ApiKey
 */
export class ApiKey extends Message<ApiKey> {
  /**
   * @generated from field: flipcash.ramp.v1.Provider provider = 1;
   */
  ...
  static readonly typeName = "flipcash.ramp.v1.ApiKey";
...
/**
 * @generated from message flipcash.ramp.v1.Jwt
 */
export class Jwt extends Message<Jwt> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "flipcash.ramp.v1.Jwt";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
