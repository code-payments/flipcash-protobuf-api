...
var file_common_v1_common_proto_rawDesc = []byte{
	...
	0x04, 0x44, 0x45, 0x53, 0x43, 0x10, 0x01, 0x22, 0x69, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x64, 0x79, 0x22, 0x92, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x3b, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x23, 0x2e, 0x66, 0x6c, 0x69, 0x70, 0x63, 0x61, 0x73, 0x68, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x01, 0x2a, 0x2e, 0x0a, 0x08, 0x50, 0x6c, 0x61, 0x74, 0x66,
...
var file_common_v1_common_proto_goTypes = []any{
	...
	(*UsdcPaymentAmount)(nil), // 8: flipcash.common.v1.UsdcPaymentAmount
	...
	(*Auth_KeyPair)(nil),      // 14: flipcash.common.v1.Auth.KeyPair
}
var file_common_v1_common_proto_depIdxs = []int32{
	14, // 0: flipcash.common.v1.Auth.key_pair:type_name -> flipcash.common.v1.Auth.KeyPair
	10, // 1: flipcash.common.v1.QueryOptions.paging_token:type_name -> flipcash.common.v1.PagingToken
	1,  // 2: flipcash.common.v1.QueryOptions.order:type_name -> flipcash.common.v1.QueryOptions.Order
	2,  // 3: flipcash.common.v1.Response.result:type_name -> flipcash.common.v1.Response.Result
	3,  // 4: flipcash.common.v1.Auth.KeyPair.pub_key:type_name -> flipcash.common.v1.PublicKey
	4,  // 5: flipcash.common.v1.Auth.KeyPair.signature:type_name -> flipcash.common.v1.Signature
