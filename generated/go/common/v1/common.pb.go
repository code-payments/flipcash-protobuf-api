...
func (x *PaymentAmount) GetNativeAmount() float64 {
	if x != nil {
...
var file_common_v1_common_proto_rawDesc = []byte{
	...
	0x02, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x96, 0x01, 0x0a, 0x0d, 0x50, 0x61, 0x79,
	...
	0x12, 0x1f, 0x0a, 0x06, 0x71, 0x75, 0x61, 0x72, 0x6b, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04,
	0x42, 0x07, 0xfa, 0x42, 0x04, 0x32, 0x02, 0x20, 0x00, 0x52, 0x06, 0x71, 0x75, 0x61, 0x72, 0x6b,
	0x73, 0x22, 0x2f, 0x0a, 0x0b, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x0a, 0x04, 0x44, 0x45, 0x53, 0x43, 0x10, 0x01, 0x2a, 0x2e, 0x0a, 0x08, 0x50, 0x6c, 0x61, 0x74,
...
var file_common_v1_common_proto_goTypes = []any{
	...
	(*PaymentAmount)(nil),   // 7: flipcash.common.v1.PaymentAmount
	(*PagingToken)(nil),     // 8: flipcash.common.v1.PagingToken
	(*QueryOptions)(nil),    // 9: flipcash.common.v1.QueryOptions
	(*Auth_KeyPair)(nil),    // 10: flipcash.common.v1.Auth.KeyPair
}
var file_common_v1_common_proto_depIdxs = []int32{
	10, // 0: flipcash.common.v1.Auth.key_pair:type_name -> flipcash.common.v1.Auth.KeyPair
	8,  // 1: flipcash.common.v1.QueryOptions.paging_token:type_name -> flipcash.common.v1.PagingToken
