...
var file_event_v1_model_proto_rawDesc = []byte{
	...
	0x0a, 0x62, 0x65, 0x74, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x42, 0x7f, 0x0a, 0x22, 0x63,
...
var file_event_v1_model_proto_goTypes = []any{
	...
	(*v11.SignedPoolMetadata)(nil), // 10: flipcash.pool.v1.SignedPoolMetadata
	(*v11.BetSummary)(nil),         // 11: flipcash.pool.v1.BetSummary
	(*v11.UserPoolSummary)(nil),    // 12: flipcash.pool.v1.UserPoolSummary
	(*v11.PoolId)(nil),             // 13: flipcash.pool.v1.PoolId
}
var file_event_v1_model_proto_depIdxs = []int32{
	...
	9,  // 6: flipcash.event.v1.UserEvent.user_id:type_name -> flipcash.common.v1.UserId
	...
	10, // 9: flipcash.event.v1.PoolResolvedEvent.pool:type_name -> flipcash.pool.v1.SignedPoolMetadata
	11, // 10: flipcash.event.v1.PoolResolvedEvent.bet_summary:type_name -> flipcash.pool.v1.BetSummary
	12, // 11: flipcash.event.v1.PoolResolvedEvent.user_summary:type_name -> flipcash.pool.v1.UserPoolSummary
	13, // 12: flipcash.event.v1.PoolBetUpdateEvent.pool_id:type_name -> flipcash.pool.v1.PoolId
	11, // 13: flipcash.event.v1.PoolBetUpdateEvent.bet_summary:type_name -> flipcash.pool.v1.BetSummary
