...
var file_activity_v1_activity_feed_service_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x33, 0x2e, 0x66, 0x6c, 0x69, 0x70, 0x63, 0x61,
	...
	0x73, 0x65, 0x42, 0x8a, 0x01, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x69,
	...
	0x02, 0x0d, 0x46, 0x50, 0x42, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x56, 0x31, 0x62,
...
var file_activity_v1_activity_feed_service_proto_goTypes = []any{
	...
	(*GetLatestNotificationsRequest)(nil),      // 1: flipcash.activity.v1.GetLatestNotificationsRequest
	(*GetLatestNotificationsResponse)(nil),     // 2: flipcash.activity.v1.GetLatestNotificationsResponse
	(ActivityFeedType)(0),                      // 3: flipcash.activity.v1.ActivityFeedType
	(*v1.Auth)(nil),                            // 4: flipcash.common.v1.Auth
	(*Notification)(nil),                       // 5: flipcash.activity.v1.Notification
}
var file_activity_v1_activity_feed_service_proto_depIdxs = []int32{
	3, // 0: flipcash.activity.v1.GetLatestNotificationsRequest.type:type_name -> flipcash.activity.v1.ActivityFeedType
	4, // 1: flipcash.activity.v1.GetLatestNotificationsRequest.auth:type_name -> flipcash.common.v1.Auth
	...
	5, // 3: flipcash.activity.v1.GetLatestNotificationsResponse.notifications:type_name -> flipcash.activity.v1.Notification
	1, // 4: flipcash.activity.v1.ActivityFeed.GetLatestNotifications:input_type -> flipcash.activity.v1.GetLatestNotificationsRequest
	2, // 5: flipcash.activity.v1.ActivityFeed.GetLatestNotifications:output_type -> flipcash.activity.v1.GetLatestNotificationsResponse
